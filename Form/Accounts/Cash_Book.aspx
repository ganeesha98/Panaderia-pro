...
<br />
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-group row">
                    ...
                    <div class="col-sm-50">    
                        <input type="text" id="country" name="country" value="BALANCE C/F" readonly style="width:130px"  > 
            ...
            <div class="col-sm-50"> 
                        ...
                        <input type="text" id="country" name="country" value="     " readonly style="width:130px"  > 
