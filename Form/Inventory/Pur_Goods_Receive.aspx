...
<br />
   ...
   <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><asp:TextBox ID="company" runat="server" CssClass="input-field" OnTextChanged="company_TextChanged"></asp:TextBox></div>
    ...
    <br />
        ...
        <br />
        <div class="form-group row">
            <div id="Panel1" style="background-color: #99ccff30; height: 358px; width: 727px;">
