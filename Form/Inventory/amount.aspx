<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="amount.aspx.cs" Inherits="Panaderia.Form.Inventory.amount" %>
    ...
    <form id="form1" runat="server">
         <div class="auto-style32">
            <div class="table-row">
                ...
                <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><asp:TextBox ID="Number" runat="server" CssClass="input-field" ReadOnly="True">1</asp:TextBox></div>
