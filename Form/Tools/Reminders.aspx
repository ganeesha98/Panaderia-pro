...
<body>
    ...
    <div class="row">
        <div class="col-md-6">
            <button type="button" id="btnSave" class="btn btn-primary" style="border-color: #000000; border-style: inset; width: 100px; background-color: #3333ffcc;">Save</button> &nbsp;&nbsp; <button type="button" id="btnExit" class="btn btn-danger" style="border-color: #000000; border-style: inset; width: 100px; background-color: #3333ffcc;">Browse</button> &nbsp;&nbsp; <button type="button" id="btnExit" class="btn btn-danger" style="border-color: #000000; border-style: inset; width: 100px; background-color: #3333ffcc;">Find</button> &nbsp;&nbsp; <button type="button" id="btnExit" class="btn btn-danger" style="border-color: #000000; border-style: inset; width: 100px; background-color: #3333ffcc;">Exit</button>
        </div>
    </div>
    </div>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
