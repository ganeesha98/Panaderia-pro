    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-6">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btn_save" runat="server" BackColor="#6600FF" Height="31px" Text="Save" Width="103px" OnClick="btn_save_Click" />
          ...
          &nbsp;<asp:Button ID="btnexit" runat="server" BackColor="#CC3300" Height="31px" Text="Exit" Width="103px" OnClick="btn_exit_Click" />
            </div>
        </div>
